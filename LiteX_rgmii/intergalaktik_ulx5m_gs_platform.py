...
_io = [
    ...
    # USB.
    ("usb", 0,
        Subsignal("d_p",    Pins("IO_EA_A0")),
        Subsignal("d_n",    Pins("IO_EA_B0")),
        Subsignal("pullup", Pins("IO_EA_A2")),
    ),
    ...
    ("eth_clk", 0,
        ...
        Subsignal("rx", Pins(f"IO_EB_A7")),#, Misc("PULLUP=true | SLEW=fast")),
    ),
    ("eth", 0,
        Subsignal("rx_ctl",  Pins(f"IO_EB_A8"),                            Misc("PULLDOWN=true | SLEW=fast")),
        Subsignal("rx_data", Pins(f"IO_EB_A0 IO_EB_B0 IO_EB_A1 IO_EB_B1"), Misc("PULLUP=true | SLEW=fast")),
        Subsignal("tx_ctl",  Pins(f"IO_EB_A2"),                            Misc("SLEW=fast")),
        Subsignal("tx_data", Pins(f"IO_EB_B5 IO_EB_A5 IO_EB_B4 IO_EB_A4")),
        Subsignal("rst_n",   Pins(f"IO_EB_B3")),
        Subsignal("mdc",     Pins(f"IO_EB_B6")),
        Subsignal("mdio",    Pins(f"IO_EB_A6"),                            Misc("PULLUP=true | SLEW=fast")),
        Misc("SLEW=fast"),
    ),
